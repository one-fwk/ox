...
describe('renderer', () => {
  ...
  describe('functional component', () => {
    ...
    it('should render a basic functional component', () => {
      ...
      vnode0 = {};
      vnode0.elm = hostElm;
      hostElm = renderer.patch(hostElm, vnode0,
        h('my-tag', null,
  ...
  describe('scoped css', () => {
    ...
    it('adds scope id to child elements', () => {
      ...
      vnode0 = {};
      vnode0.elm = hostElm;
      hostElm = renderer.patch(hostElm, vnode0, h('my-tag', null, h('div', null)), false, 'scoped').elm;
  ...
  describe('created element', () => {
    ...
    it('has tag', () => {
      hostElm = renderer.patch(hostElm, vnode0, h('div', null)).elm;
    ...
    it('can create elements with text content', () => {
      hostElm = renderer.patch(hostElm, vnode0, h('div', null, 'I am a string')).elm;
  ...
  describe('patching an element', () => {
    ...
    it('changes elements classes from previous vnode', () => {
      ...
      renderer.patch(hostElm, vnode0, vnode1);
      hostElm = renderer.patch(hostElm, vnode1, vnode2).elm;
    ...
    describe('using toVNode()', () => {
      ...
      it('can remove previous children of the root element', () => {
        ...
        hostElm = renderer.patch(hostElm, toVNode(prevElm), nextVNode).elm;
      ...
      it('can remove previous children of the root element with update', () => {
        ...
        const nextVNode = h('div', null, h('span', null, 'Hi'));
        hostElm = renderer.patch(hostElm, toVNode(prevElm), nextVNode, true).elm;
    ...
    describe('updating children with keys', () => {
      ...
      describe('removal of elements', () => {
        ...
        it('removes child svg elements', () => {
          ...
          const resultA = renderer.patch(hostElm, vnode0, a);
          expect(resultA.elm.childNodes.length).toEqual(2);

          const resultB = renderer.patch(hostElm, resultA, b);
      ...
      it('handles random shuffles', () => {
        ...
        for (n = 0; n < samples; ++n) {
          ...
          vnode0.elm = elm;
          elm = renderer.patch(hostElm, vnode0, vnode1).elm;
          ...
          elm = renderer.patch(hostElm, vnode1, vnode2).elm;
          for (i = 0; i < elms; ++i) {
      ...
      it('supports all null/undefined children', () => {
        ...
        hostElm = renderer.patch(hostElm, vnode2, vnode3).elm;
    ...
    describe('updating children without keys', () => {
      ...
      it('removes a single text node', () => {
        ...
        renderer.patch(hostElm, vnode1, vnode2);
