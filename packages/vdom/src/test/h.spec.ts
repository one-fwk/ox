import { h } from '../h';
import { FunctionalComponent } from '@ox/collection';
import { isSameVNode } from '@ox/vdom';
...
describe('h()', () => {
  ...
  describe('functional components', () => {
    ...
    it('should receive props, array, and utils as props', async () => {
      let args: any;
      const MyFunction: FunctionalComponent = (...argArray) => {
        args = argArray;
        return null;
      };
    ...
    it('should handle functional cmp which returns null', async () => {
      const MyFunction: FunctionalComponent = () => { return null; };
    ...
    it('should render functional cmp content', async () => {
      const MyFunction: FunctionalComponent = () => {
